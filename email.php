...
define('GUSER', 'jonhpyter2006@gmail.com');	// <-- Insira aqui o seu GMail
define('GPWD', 'Jonny2006@');		// <-- Insira aqui a senha do seu GMail
...
// Insira abaixo o email que irá receber a mensagem, o email que irá enviar (o mesmo da variável GUSER), o nome do email que envia a mensagem, o Assunto da mensagem e por último a variável com o corpo do email.
 ...
 if (smtpmailer('unifytelecom1@gmail.com', 'jonhpyter2006@gmail.com', 'Nome do Enviador', 'Assunto do Email', $Vai)) {
